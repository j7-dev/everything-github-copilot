/**
 * Cross-platform utility functions for Copilot CLI hooks and scripts.
...
/** Get the learned skills directory (~/.copilot/skills/learned) */
...
/** Log a message to stderr (visible to user in Copilot CLI terminal) */
