 ...
 *
 * Detection priority:
 * 1. COPILOT_PACKAGE_MANAGER environment variable
 * 2. Project-specific config (.copilot/package-manager.json)
 * 3. package.json `packageManager` field
 * 4. Lock file detection
 * 5. Global user preference (~/.copilot/package-manager.json)
 ...
 * Saves to ~/.copilot/package-manager.json.
 ...
 * Saves to <projectDir>/.copilot/package-manager.json.
