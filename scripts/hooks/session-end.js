  ...
  for (const line of lines) {
    try {
      ...
      if (entry.type === 'user' || entry.role === 'user' || entry.message?.role === 'user') {
        // Support both direct content and nested message.content (Copilot CLI JSONL format)
      ...
      // Extract tool uses from assistant message content blocks (Copilot CLI JSONL format)
...
// Read hook input from stdin (Copilot CLI provides transcript_path via stdin JSON)
