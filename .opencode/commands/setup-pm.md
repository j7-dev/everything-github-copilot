...
2. **Project config**: `.copilot/package-manager.json`
...
```bash
# Create .copilot/package-manager.json
echo '{"packageManager": "pnpm"}' > .copilot/package-manager.json
```
...
```bash
# Create ~/.copilot/package-manager.json
echo '{"packageManager": "yarn"}' > ~/.copilot/package-manager.json
```
