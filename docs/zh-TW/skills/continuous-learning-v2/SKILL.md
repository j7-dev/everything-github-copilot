...
進階學習系統，透過原子「本能」（帶信心評分的小型學習行為）將你的 Copilot CLI 工作階段轉化為可重用知識。
...
```bash
# 啟動背景觀察者
~/.copilot/skills/continuous-learning-v2/agents/start-observer.sh
```
...
v2 完全相容 v1：
- 現有 `~/.copilot/skills/learned/` 技能仍可運作
