---
name: eval-harness
description: Formal evaluation framework for Copilot CLI sessions implementing eval-driven development (EDD) principles
tools: Read, Write, Edit, Bash, Grep, Glob
---

# Eval Harness 技能

Copilot CLI 工作階段的正式評估框架，實作 eval 驅動開發（EDD）原則。
...
```
在 `.copilot/evals/feature-name.md` 建立 eval 定義檔案
