# 貢獻 Everything Copilot CLI

感謝您想要貢獻。本儲存庫旨在成為 Copilot CLI 使用者的社群資源。
...
```bash
git clone https://github.com/YOUR_USERNAME/everything-copilot-cli.git
