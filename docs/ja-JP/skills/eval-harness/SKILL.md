---
name: eval-harness
description: Copilot CLIセッションの正式な評価フレームワークで、評価駆動開発（EDD）の原則を実装します
tools: Read, Write, Edit, Bash, Grep, Glob
---

# Eval Harnessスキル

Copilot CLIセッションの正式な評価フレームワークで、評価駆動開発（EDD）の原則を実装します。
...
```
`.copilot/evals/feature-name.md`に評価定義ファイルを作成
