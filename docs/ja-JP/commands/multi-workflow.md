...
| 計画 | `~/.copilot/.ccg/prompts/codex/architect.md` | `~/.copilot/.ccg/prompts/gemini/architect.md` |
| レビュー | `~/.copilot/.ccg/prompts/codex/reviewer.md` | `~/.copilot/.ccg/prompts/gemini/reviewer.md` |
...
**Claude統合**: Codexのバックエンド計画 + Geminiのフロントエンド計画を採用し、ユーザーの承認後に`.copilot/plan/task-name.md`に保存します。
