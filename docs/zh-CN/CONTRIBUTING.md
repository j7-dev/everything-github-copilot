# 为 Everything Copilot CLI 做贡献

感谢您想要贡献！这个仓库是 Copilot CLI 用户的社区资源。
...
# 4. Test locally
cp -r skills/my-skill ~/.copilot/skills/  # for skills
# Then test with Copilot CLI
...
* **问题：** [github.com/affaan-m/everything-copilot-cli/issues](https://github.com/affaan-m/everything-copilot-cli/issues)
