...
description: 自动从Copilot CLI会话中提取可重用模式，并将其保存为学习技能供未来使用。
---

# 持续学习技能

自动评估 Copilot CLI 会话的结尾，以提取可重用的模式，这些模式可以保存为学习到的技能。
...
2. **模式检测**：从会话中识别可提取的模式
3. **技能提取**：将有用的模式保存到 `~/.copilot/skills/learned/`
