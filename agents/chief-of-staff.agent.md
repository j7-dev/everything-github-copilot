...
tools: ["view", "grep", "glob", "bash", "edit", "edit"]
---
...
- **Rules are system-injected**: `.copilot/rules/*.md` files load automatically every session. Unlike prompt instructions, the LLM cannot choose to ignore them.
...
- [Copilot CLI](https://docs.anthropic.com/en/docs/copilot-cli)
