...
This is a **production-ready AI coding plugin** providing 13 specialized agents, 50+ skills, 26 commands, and automated hook workflows for software development.
...
.github/         — Copilot instructions (copilot-instructions.md + *.instructions.md)
