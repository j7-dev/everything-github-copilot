...
> 來源：https://abp.io/docs/9.3/modules/identity-pro
...
> 
The data seed contributor class of the Identity module is IdentityDataSeedContributor which internally uses the IIdentityDataSeeder service.
