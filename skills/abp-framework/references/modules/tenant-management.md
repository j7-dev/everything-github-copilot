...
> 來源：https://abp.io/docs/9.3/modules/tenant-management
...
TenantEto is configured to automatically publish the events. You should configure yourself for the others. See the Distributed Event Bus document to learn details of the pre-defined events.
