...
> 來源：https://abp.io/docs/9.3/modules/payment-custom-gateway
...
- Create MyPaymentGateway.cs in the Domain layer of your project and implement IPaymentGateway . public class MyPaymentGateway : IPaymentGateway, ITransientDependency
  {
...
- You should also configure PaymentOptions for your gateway in the Domain layer of your project as shown below. Configure<PaymentOptions>(options =>
  {
...
- Create PreCheckout.cshtml and PreCheckout.cshtml.cs @model PreCheckoutModel
...
</form> public class PreCheckoutModel : AbpPageModel
{
...
- Create PostCheckout.cshtml and PostCheckout.cshtml.cs @model PostCheckoutModel

<h3>Operation Done</h3>
- Configure your pages using PaymentWebOptions in Web layer of your project. Configure<PaymentWebOptions>(options =>
{
