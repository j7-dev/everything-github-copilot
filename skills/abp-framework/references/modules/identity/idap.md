...
> 來源：https://abp.io/docs/9.3/modules/identity/idap
...
The Identity PRO module has built-in LdapExternalLoginProvider and OpenLdapManager services. It implements LDAP authentication and gets user info for external login .
