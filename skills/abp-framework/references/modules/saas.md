...
> 來源：https://abp.io/docs/9.3/modules/saas
...
- Install Volo.Payment module. abp add-module Volo.Payment Or you can install via using ABP Suite.
- Configure Saas module to use Payment. Configure<AbpSaasPaymentOptions>(options =>
{
...
- Inject ISubscriptionAppService to create a subscription for a edition: public class IndexModel : PageModel
{
...
- SaasTenants SaasTenantConnectionStrings
- SaasEditions
...
TenantEto and EditionEto are configured to automatically publish the events. You should configure yourself for the others. See the Distributed Event Bus document to learn details of the pre-defined events.
