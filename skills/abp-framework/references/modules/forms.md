...
> 來源：https://abp.io/docs/9.3/modules/forms
...
- Via ABP CLI: Open a command line window in your solution folder (in the folder where the * .sln file is located) and type the following command: abp add-module Volo.Forms
...
- Form The main aggregate root of the form entities. The form options, title and description is being stored on this entity.
- QuestionBase It stores questions of the form. This entity is dependent to form entity by FormId .
- FormResponse Each form submit is a new form response record. The form response has answer records.
