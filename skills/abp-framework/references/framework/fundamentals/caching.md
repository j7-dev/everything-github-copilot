...
> 來源：https://abp.io/docs/9.3/framework/fundamentals/caching
...
- It provides a single key pool for all cache items, so; You need to care about the keys to distinguish different types of objects . You need to care about the cache items of different tenants in a multi-tenant system.
