...
> 來源：https://abp.io/docs/9.3/framework/fundamentals/Validation
...
- AbpValidationException is automatically caught by the ABP and converted to a usable error into with HTTP 400 status code. See the exception handling document for more.
