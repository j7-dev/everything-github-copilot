...
> 來源：https://abp.io/docs/9.3/framework/fundamentals/localization
...
- Localization for the MVC / Razor Pages UI
- Localization for the Blazor UI
- Localization for the Angular UI
- Video tutorial
