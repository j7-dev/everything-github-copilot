...
> 來源：https://abp.io/docs/9.3/framework/fundamentals/object-extensions

# Object Extensions

ABP provides an object extension system to allow you to add extra properties to an existing object without modifying the related class. This allows to extend functionalities implemented by a depended application module , especially when you want to extend entities and DTOs defined by the module.
...
If you're using the AutoMapper library, the ABP also provides an extension method to utilize the MapExtraPropertiesTo method defined above.
