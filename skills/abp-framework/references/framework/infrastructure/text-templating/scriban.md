...
> 來源：https://abp.io/docs/9.3/framework/infrastructure/text-templating/scriban
...
1. Add the Volo.Abp.TextTemplating.Scriban NuGet package to your project:
...
1. Add the AbpTextTemplatingScribanModule to the dependency list of your module:
