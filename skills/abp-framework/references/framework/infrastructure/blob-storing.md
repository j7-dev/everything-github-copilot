...
> 來源：https://abp.io/docs/9.3/framework/infrastructure/blob-storing

# BLOB Storing

It is typical to store file contents in an application and read these file contents on need. Not only files, but you may also need to save various types of large binary objects , a.k.a. BLOB s, into a storage . For example, you may want to save user profile pictures.
...
- Google : Stores BLOBs on the Google Cloud Storage .
- Bunny : Stores BLOBs on the Bunny.net Storage .
...
- Creating a custom BLOB storage provider
