...
> 來源：https://abp.io/docs/9.3/framework/infrastructure/background-workers/quartz

# Quartz Background Worker Manager

Quartz is an advanced background worker manager. You can integrate Quartz with the ABP to use it instead of the default background worker manager . ABP simply integrates quartz.
...
1. Add the Volo.Abp.BackgroundWorkers.Quartz NuGet package to your project: dotnet add package Volo.Abp.BackgroundWorkers.Quartz
...
> 
Quartz background worker integration provided QuartzPeriodicBackgroundWorkerAdapter to adapt PeriodicBackgroundWorkerBase and AsyncPeriodicBackgroundWorkerBase derived class. So, you can still fllow the background workers document to define the background worker.
