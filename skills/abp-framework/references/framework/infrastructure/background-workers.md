...
> 來源：https://abp.io/docs/9.3/framework//infrastructure/background-workers
...
> 
You can use CronExpression property to set the cron expression for the background worker if you will use the Hangfire Background Worker Manager or Quartz Background Worker Manager .
