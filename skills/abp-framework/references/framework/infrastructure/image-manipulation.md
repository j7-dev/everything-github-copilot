...
> 來源：https://abp.io/docs/9.3/framework/infrastructure/image-manipulation

# Image Manipulation

ABP provides services to compress and resize images and implements these services with popular ImageSharp and Magick.NET libraries. You can use these services in your reusable modules, libraries and applications, so you don't depend on a specific imaging library.
...
You can add this package to your application by either using the ABP CLI or manually installing it. Using the ABP CLI is the recommended approach.
...
1. Add the Volo.Abp.Imaging.Abstractions NuGet package to your project:
...
1. Add the AbpImagingAbstractionsModule to the dependency list of your module:
...
You can inject the IImageResizer service and use it for image resize operations. Here is the available methods of the IImageResizer service:
...
- Mode : The resize mode (see the ImageResizeMode section for more information).
...
> 
See the ImageSharp documentation for more information about the resize modes.
...
ImageResizeOptions is an options object that is used to configure the image resize system. It has the following properties:

- DefaultResizeMode : The default resize mode. (Default: ImageResizeMode.None )

## IImageCompressor

You can inject the IImageCompressor service and use it for image compression operations. Here is the available methods of the IImageCompressor service:
...
Volo.Abp.Imaging.MagickNet NuGet package implements the image operations using the Magick.NET library.
...
1. Add the Volo.Abp.Imaging.MagickNet NuGet package to your project:
...
1. Add AbpImagingMagickNetModule to your module 's dependency list:
...
MagickNetCompressOptions is an options object that is used to configure the Magick.NET image compression system. It has the following properties:
...
Volo.Abp.Imaging.ImageSharp NuGet package implements the image operations using the ImageSharp library.
...
1. Add the Volo.Abp.Imaging.ImageSharp NuGet package to your project:
...
1. Add AbpImagingImageSharpModule to your module 's dependency list:
...
ImageSharpCompressOptions is an options object that is used to configure the ImageSharp image compression system. It has the following properties:
...
1. Add the Volo.Abp.Imaging.AspNetCore NuGet package to your project:
...
1. Add AbpImagingAspNetCoreModule to your module 's dependency list:
