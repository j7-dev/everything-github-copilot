...
> 來源：https://abp.io/docs/9.3/framework/infrastructure/virtual-file-system
...
Volo.Abp.VirtualFileSystem is the main package of the Virtual File System.
...
If two modules adds a file to the same virtual path (like my-path/my-file.css ), the one added later overrides/replaces the previous one ( module dependency order determines the order of the files being added).
