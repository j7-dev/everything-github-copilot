...
> 來源：https://abp.io/docs/9.3/framework//infrastructure/background-jobs/quartz

# Quartz Background Job Manager

Quartz is an advanced background job manager. You can integrate Quartz with the ABP to use it instead of the default background job manager . In this way, you can use the same background job API for Quartz and your code will be independent of Quartz. If you like, you can directly use Quartz's API, too.
...
1. Add the Volo.Abp.BackgroundJobs.Quartz NuGet package to your project: dotnet add package Volo.Abp.BackgroundJobs.Quartz
