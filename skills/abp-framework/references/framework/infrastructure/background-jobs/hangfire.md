...
> 來源：https://abp.io/docs/9.3/framework/infrastructure/background-jobs/hangfire
...
1. Add the Volo.Abp.BackgroundJobs.HangFire NuGet package to your project: dotnet add package Volo.Abp.BackgroundJobs.HangFire
...
To make it secure by default, only local requests are allowed, however you can change this by following the official documentation of Hangfire.
