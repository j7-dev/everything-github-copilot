...
> 來源：https://abp.io/docs/9.3/framework/infrastructure/event-bus/distributed/kafka
...
If you want to do it manually, install the Volo.Abp.EventBus.Kafka NuGet package to your project and add [DependsOn(typeof(AbpEventBusKafkaModule))] to the ABP module class inside your project.
