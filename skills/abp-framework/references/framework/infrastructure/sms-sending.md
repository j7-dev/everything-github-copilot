...
> 來源：https://abp.io/docs/9.3/framework/infrastructure/sms-sending
...
NullSmsSender is a the default implementation of the ISmsSender . It writes SMS content to the standard logger , rather than actually sending the SMS.
