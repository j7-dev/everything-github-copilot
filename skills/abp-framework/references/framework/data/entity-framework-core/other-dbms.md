...
> 來源：https://abp.io/docs/9.3/framework/data/entity-framework-core/other-dbms
...
- Remove the Volo.Abp.EntityFrameworkCore.SqlServer NuGet package dependency from the .EntityFrameworkCore project.
- Add the Pomelo.EntityFrameworkCore.MySql NuGet package dependency to your .EntityFrameworkCore project.
