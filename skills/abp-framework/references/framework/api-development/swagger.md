...
> 來源：https://abp.io/docs/9.3/framework/api-development/swagger
...
1. Add the Volo.Abp.Swashbuckle NuGet package to your Web or HttpApi.Host project: dotnet add package Volo.Abp.Swashbuckle
2. Add the AbpSwashbuckleModule to the dependency list of your module: [DependsOn(
    //...other dependencies
...
> 
ABP uses OpenIddict by default. To get more information about OpenIddict, check this documentation .
