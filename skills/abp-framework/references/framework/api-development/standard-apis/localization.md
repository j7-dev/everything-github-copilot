...
> 來源：https://abp.io/docs/9.3/framework/api-development/standard-apis/localization

# Application Localization Endpoint

ABP provides a pre-built and standard endpoint that returns all the localization resources and texts defined in the server.
...
For ASP.NET Core MVC (Razor Pages) applications, the same localization data is also available on the JavaScript side. /Abp/ApplicationLocalizationScript is the URL of the script that is auto-generated based on the HTTP API above.
