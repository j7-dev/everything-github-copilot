...
> 來源：https://abp.io/docs/9.3/framework/api-development/static-csharp-clients
...
ABP provides two types of client proxy generation system. This document explains the static client proxies , which generates client-side code in your development time. You can also see the Dynamic C# API Client Proxies documentation to learn how to use proxies generated on runtime.
