...
> 來源：https://abp.io/docs/9.3/framework/api-development/versioning

# API Versioning System

ABP integrates the ASPNET-API-Versioning feature and adapts to C# and JavaScript Static Client Proxies and Auto API Controller .
...
This feature does not compatible with URL Path Versioning , we suggest to use Versioning-via-the-Query-String .
