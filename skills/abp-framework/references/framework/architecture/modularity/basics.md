...
> 來源：https://abp.io/docs/9.3/framework//architecture/modularity/basics
...
- The modular monolith application development tutorial explains and demonstrates how to build modular monolith applications with ABP.
- Pre-built application modules are ready to use in any kind of application.
- Module startup template is a jump start way to create a new reusable application module .
...
- Video tutorial for basic modularity
