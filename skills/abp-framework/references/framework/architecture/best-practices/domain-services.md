...
> 來源：https://abp.io/docs/9.3/framework/architecture/best-practices/domain-services
...
- Do throw BusinessException or custom business exception if a validation fails. Do use domain error codes with unique code-namespace for exception localization.
