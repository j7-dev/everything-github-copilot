...
> 來源：https://abp.io/docs/9.3/framework/ui/mvc-razor-pages/layout-hooks

# ASP.NET Core MVC / Razor Pages: Layout Hooks

ABP theming system places the page layout into the theme NuGet packages. That means the final application doesn't include a Layout.cshtml , so you can't directly change the layout code to customize it.
...
ABP provides different ways of customizing the UI .
