...
> 來源：https://abp.io/docs/9.3/framework/ui/mvc-razor-pages/javascript-api/settings
...
> 
This document only explains the JavaScript API. See the settings document to understand the ABP setting system.
