...
> 來源：https://abp.io/docs/9.3/framework/ui/mvc-razor-pages/dynamic-javascript-proxies
...
ABP provides two types of client proxy generation system. This document explains the dynamic client proxies , which generates client-side proxies on runtime. You can also see the Static JavaScript API Client Proxies documentation to learn how to generate proxies on development time.
