...
> 來源：https://abp.io/docs/9.3/framework/ui/mvc-razor-pages/customization-user-interface

# ASP.NET Core (MVC / Razor Pages) User Interface Customization Guide

This document explains how to override the user interface of a depended application module or theme for ASP.NET Core MVC / Razor Page applications.
...
> 
Don't forget to add _ViewImports.cshtml if the page you want to override contains ABP Tag Helpers .
...
The Bundling & Minification system provides an extensible and dynamic system to create script and style bundles. It allows you to extend and manipulate the existing bundles.
...
Then add this file to the standard global style bundle in the ConfigureServices method of your module :
...
Menu contributors are executed whenever need to render the menu. There is already a menu contributor defined in the application startup template , so you can take it as an example and improve if necessary. See the navigation menu document for more.

### Toolbar Contributors

Toolbar system is used to define toolbars on the user interface. Modules (or your application) can add items to a toolbar, then the theme renders the toolbar on the layout .
...
See the toolbars document for more about the toolbar system.

### Layout Hooks

Layout Hooks system allows you to add code at some specific parts of the layout. All layouts of all themes should implement these hooks. Then you can then add a view component into a hook point.
