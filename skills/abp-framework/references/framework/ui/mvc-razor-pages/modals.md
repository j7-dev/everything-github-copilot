...
> 來源：https://abp.io/docs/9.3/framework/ui/mvc-razor-pages/modals

# ASP.NET Core MVC / Razor Pages UI: Modals

While you can continue to use the standard Bootstrap way to create, open and manage modals in your applications, ABP provides a flexible way to manage modals by automating common tasks for you.
...
- abp-input Tag Helper can understand the data annotation attributes and uses them to shape and validate the form elements. See the abp-input tag helpers document to learn more.
...
See the Forms & Validation document to learn more about the validation.
...
- We've use the abp-script Tag Helper here. See the Bundling & Minification document if you want to understand it. You can use the standard script tag. It doesn't matter for this case.
...
Instead, you can use the Bundling & Minification system to create a bundle (that is a single and minified file on production) for all the used script files for a page:
