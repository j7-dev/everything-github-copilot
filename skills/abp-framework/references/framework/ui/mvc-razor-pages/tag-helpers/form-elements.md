...
> 來源：https://abp.io/docs/9.3/framework/ui/mvc-razor-pages/tag-helpers/form-elements
...
- [FormControlSize()] : Sets the size of the form-control wrapper element. Available values are AbpFormControlSize.Default AbpFormControlSize.Small AbpFormControlSize.Medium AbpFormControlSize.Large
...
- size : Sets the size of the form-control wrapper element. Available values are AbpFormControlSize.Default AbpFormControlSize.Small AbpFormControlSize.Medium AbpFormControlSize.Large
