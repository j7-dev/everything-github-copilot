...
> 來源：https://abp.io/docs/9.3/framework/ui/mvc-razor-pages/tag-helpers/modals

# Modals

> 
This document explains the details of the abp-modal Tag Helper, which simplifies to build the HTML markup for a modal dialog. Read that documentation to learn how to work with modals.
...
See the modals demo page to see it in action.
