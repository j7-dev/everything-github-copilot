...
> 來源：https://abp.io/docs/9.3/framework/ui/blazor/theming
...
- Provides a system that consists of layout parts (like navigation menus and toolbars ) that is implemented by all the themes. So, the modules and the application to contribute to the layout to compose a consistent application UI.
...
- The LeptonX Theme is a theme that has a commercial and a lite version.
