...
> 來源：https://abp.io/docs/9.3/framework/ui/blazor/navigation-menu
...
AboutMenuItemComponent.razor component will be renderd for the menu item.
...
There is a special menu item in the menu that is added by the ABP: The Administration menu. It is typically used by the pre-built admin application modules :
