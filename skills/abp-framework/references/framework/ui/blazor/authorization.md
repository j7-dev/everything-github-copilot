...
> 來源：https://abp.io/docs/9.3/framework/ui/blazor/authorization
...
> 
ABP is 100% compatible with the Authorization infrastructure provided by the Blazor. See the Blazor Security Document to learn all authorization options. This section only shows some common scenarios .
...
- CheckAsync checks and throws AbpAuthorizationException if given policy/permission hasn't granted. You don't have to handle these kind of exceptions since ABP automatically handles errors .
...
- Blazor Security (Microsoft documentation)
