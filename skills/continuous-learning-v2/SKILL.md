...
An advanced learning system that turns your Copilot CLI sessions into reusable knowledge through atomic "instincts" - small learned behaviors with confidence scoring.

Inspired in part by the Homunculus work from [humanplane](https://github.com/humanplane).

## When to Activate

- Setting up automatic learning from Copilot CLI sessions
