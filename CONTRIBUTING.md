...
Thanks for wanting to contribute! This repo is a community resource for Copilot CLI users.
...
Skills are knowledge modules that Copilot CLI loads based on context.
...
Hooks are automatic behaviors triggered by Copilot CLI events.
